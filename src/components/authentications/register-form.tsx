...
export function RegisterForm({
  ...
  const handleRegister = (value: z.infer<typeof formSchema>) => {
    console.warn(value);
    navigate("/dashboard");
  };
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleRegister)} className="grid gap-4 w-full mx-auto">
          ...
          <div className="flex justify-end">
            <NavLink to="/auth/forgot-password" className="font-semibold text-sm text-primary">
              Forgot Password?
            </NavLink>
          </div>

          <div className="flex flex-col justify-end w-full gap-2 mt-4">
            <Button size="lg" type="submit" className="w-full bg-primary">
              Login
            </Button>
